...
def update_database(erstattung, entrygroup_id, booking_id):
...
def book_kobu_ueberweisung(erstattung, lastschrift_properties, lastschrift_id):
    ...
    entrygroup_id = config["webling_api"].create_buchung(erstattung, lastschrift_id, belege)
    ...
    update_database(erstattung, entrygroup_id, booking_id)
